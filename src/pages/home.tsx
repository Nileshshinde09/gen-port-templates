      ...
      <div className="container mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="flex justify-between items-center mb-12">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-2">
            ...
            <span className="text-lg font-medium text-gray-900 dark:text-gray-100">{fullName || "John Doe"}</span>
          </motion.div>
          <Switch checked={darkMode} onCheckedChange={toggleDarkMode} />
        </div>

        {/* Profile Section */}
        <motion.section initial="hidden" animate="visible" variants={fadeIn} className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">{fullName || "John Doe"}</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-6">{designation || "Full Stack Developer"}</p>
        ...
        <motion.section initial="hidden" animate="visible" variants={fadeIn} className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {(skills.length > 0 ? skills : ["JavaScript", "TypeScript", "React", "Node.js", "Python", "AWS"]).map(
              (skill, i) => (
                <Badge
                  key={i}
                  variant="outline"
